          ...
          <div className="border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
            <div className="-mx-4 flex flex-wrap items-center">
              <div className="w-full px-4 lg:w-2/3">
                <SectionTitle title="Privacy Policy" paragraph="" mb="20px" />
                      ...
                      <ul>
                        ...
                        <li>
                          <p>
                            ...
                            refers to Dongguan 3G Audio Technology Co.,Ltd.,
                            Building 3, No.1 Nanqi street, Qiaodong road,
                            Qiaotou town, Dongguan City, Guangdong province,
                            523539 China.
                          </p>
                        </li>
                        <li>
