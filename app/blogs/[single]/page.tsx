...
const Article = async ({ params }) => {
  ...
  let { description, title, image, images } = frontmatter;
  return (
    <>
                      ...
                      <div className="flex items-center lg:block xl:flex">
                        <div className="mr-5 lg:mb-3 xl:mb-0">
                          <div className="relative h-[60px] w-[70px] overflow-hidden rounded-10 sm:h-[75px] sm:w-[85px]">
                            <Image src={post.frontmatter.image} alt={post.frontmatter.title} fill />
                          </div>
                        </div>
                        <div className="w-full">
                          ...
                          <p className="text-xs font-medium text-body-color">{post.frontmatter.date}</p>
                        </div>
                      </div>
                    </li>
                  ))}
